 ...
 *--------------------------------------------------------------------------------------------*/
import { Property, SealedChoiceSchema, ObjectSchema, SchemaType, ParameterLocation, getAllProperties, ChoiceSchema, Schema, ConstantSchema } from '@autorest/codemodel';
