...
import { camelCase, deconstruct, EOL, nameof } from '@azure-tools/codegen';
import { IsNotNull } from '@azure-tools/codegen-csharp';
import { System } from '@azure-tools/codegen-csharp';
import { Expression, ExpressionOrLiteral, StringExpression, toExpression, valueOf } from '@azure-tools/codegen-csharp';
...
import { getSchemaDetails } from '../../utils/schema';
...
export class ObjectImplementation implements EnhancedTypeDeclaration {
  ...
  get declaration(): string {
    const schema = getSchemaDetails(this.schema);
